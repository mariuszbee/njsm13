				...
				<div tw="bg-gray-50 flex w-full">
					<div tw="flex flex-col md:flex-row w-full py-12 px-4 md:items-center justify-between p-8">
						<h2 tw="flex flex-col text-3xl sm:text-4xl font-extrabold tracking-tight text-gray-900 text-left max-w-[50%]">
							...
							<span tw="text-yellow-300 text-lg">{product.product?.categories[0]?.name}</span>
							<span tw="text-2xl">{product.product?.description.slice(0, 100) + "..."}</span>
						</h2>
						<div tw="mt-8 flex md:mt-0">
							<div tw="flex rounded-md shadow">
								<div tw="flex items-center justify-center rounded-md border border-transparent  px-5 py-3 text-base font-medium text-white">
